...
public class Chunk : MonoBehaviour
{
    ...
    void CubeTop(int x, int y, int z, byte block)
    {
        ...
        switch(Block(x, y, z))
        {
            case 1: texturePos = tStone;
                    break;
            case 2: texturePos = tGrassTop;
                    break;
            case 3: texturePos = tWood;
                    break;
            case 4: texturePos = tWater;
                    break;
            case 5: texturePos = tSand;
                    break;
            case 6: texturePos = tFire;
                    break;
            case 7: texturePos = tClay;
                    break;
            case 8:
                texturePos = tMetal;
                break;
    ...
    void CubeNorth(int x, int y, int z, byte block)
    {
        ...
        switch (Block(x, y, z))
        {
            case 1: texturePos = tStone;
                    break;
            case 2: texturePos = tGrass;
                    break;
            case 3: texturePos = tWoodSide;
                    break;
            case 4: texturePos = tWater;
                    break;
            case 5: texturePos = tSand;
